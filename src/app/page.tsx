...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#000043]">
      {/* Navigation */}
      <nav className="bg-yellow-600 backdrop-blur-md border-b border-white/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          />
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#instructions" className="text-white/80 hover:text-white transition-colors">Instructions</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-4 max-w-md">
                A modern online examination platform designed for Mathal Int'l School to conduct secure and efficient assessments.
              </p>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 Mathal Int'l School. All rights reserved. Designed for educational purposes.
            </p>
          </div>
        </div>
      </footer>
